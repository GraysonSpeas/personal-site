...
export const fishTypes = [
    { species: 'Clownfish', base_weight: 1.2, base_length: 10.5, stamina: 150, tug_strength: 105, direction_change_rate: 200, sell_price: 100, zones: ['Ocean'], rarity: 'common' },
    ...
    { species: 'Catfish', base_weight: 5.0, base_length: 25.0, stamina: 150, tug_strength: 100, direction_change_rate: 150, sell_price: 250, zones: ['River'], rarity: 'common' },
