/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e818a416d17c0f604967702606556a11)
// Runtime types generated with workerd@1.20250525.0 2024-05-31 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		SENDER_EMAIL: "welcome@speas.org";
		SENDER_DOMAIN: "speas.org";
		BASE_URL: string;
		FROM_EMAIL: string;
